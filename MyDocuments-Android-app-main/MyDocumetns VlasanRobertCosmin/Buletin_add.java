...
public class Buletin_add extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buletin_add);
        ...
        recBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(imageUri == null)
                {
                    Toast.makeText(Buletin_add.this, "Pick an image", Toast.LENGTH_SHORT).show();
    ...
    private void openSave(){
        ...
        // String Regex = "\\\\b((?:\\\\d{4}-\\\\d{2}-\\\\d{2})|(?:\\\\d{2}/\\\\d{2}/\\\\d{4})|(?:\\\\b(January|February|March|April|May|June|July|August|September|October|November|December)\\\\s+\\\\d{1,2}(?:st|nd|rd|th)?,?\\\\s+\\\\d{4}\\\\b))\\\\b";
        // String date2 = DateExtrasa;
        String datetemp = Textedit.getText().toString().replaceAll("[^\\d.-]", "");;
        //String DateExtrasa = extractDate(Textedit.getText().toString());
        String DateExtrasa = extractDate(datetemp);
        //String DateExtrasa = extractDate2(DateExtrasa2);
   ...
   // if (currentTime.compareTo(date1) < 0) {
        ...
        if (DateExtrasa.isEmpty())
            Toast.makeText(Buletin_add.this, "Nu sau introdus date!", Toast.LENGTH_SHORT).show();
        else {
            File file = new File(getFilesDir(), "Buletin.txt");
            try {
                FileWriter fileWriter = new FileWriter(file, true);
                fileWriter.write(DateExtrasa + "\n");
                fileWriter.flush();
                fileWriter.close();

                Toast.makeText(Buletin_add.this, "Datlee au fost salvate cu  succes!", Toast.LENGTH_SHORT).show();
                finish();
            } catch (Exception e) {
                Toast.makeText(Buletin_add.this, "Nu sau putut salva datele!", Toast.LENGTH_SHORT).show();
            }
        }
   // } else {

     //   Toast.makeText(Buletin_add.this, "Nu sau putut salva datele deoarece data este deja expirata!", Toast.LENGTH_SHORT).show();
   // }
}
            ...
            Task<Text> textTaskResult = textRecoggnizer.process(inputimage).addOnSuccessListener(new OnSuccessListener<Text>() {
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(Buletin_add.this, "Error", Toast.LENGTH_SHORT).show();
                        }
                    });
            ...
            new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if(result.getResultCode()== Activity.RESULT_OK)
                    {
                        ...
                        Toast.makeText(Buletin_add.this,"Canceleed...",Toast.LENGTH_SHORT).show();
    ...
    private static String extractDate(String text) {
        // Regex pattern for extracting dates in the format DD/MM/YYYY
